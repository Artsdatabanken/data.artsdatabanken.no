...
curl -X POST --data-urlencode "payload={\"channel\": \"$slack_user\", \"username\": \"travis not the band\", \"text\": \"slack_command\", \"icon_emoji\": \":ghost:\"}" https://hooks.slack.com/services/$SLACK_TOKEN